 ...
 */
@Medium
interface LeetCode213HouseRobberII {

  int rob(int[] nums);

  LeetCode213HouseRobberII DP_method = new LeetCode213HouseRobberII() {
  ...
  LeetCode213HouseRobberII DP_Improved_method = new LeetCode213HouseRobberII() {
